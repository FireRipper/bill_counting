...
namespace CalculationFormUAH.forms
{
    public partial class formCalculationUAH : UserControl
    {
        ...
        public int bill_500, res_1, bill_200, res_2, bill_100, res_3, bill_50, res_4,
                   bill_20, res_5, bill_10, res_6, bill_5, res_7, bill_2, res_8, bill_1, res_9, res_10;

        public formCalculationUAH()
        {
            InitializeComponent();
        }
        ...
        private void btn_clear_mtb_Click(object sender, EventArgs e)
        {
            ClearAlltextBox();
            ClearLabels();
            mTB1.Focus();
        ...
        private void mTB10_TextChanged_1(object sender, EventArgs e)
        {
            Calculate();
        }

        private void mTB1_MouseClick_1(object sender, MouseEventArgs e)
        {
